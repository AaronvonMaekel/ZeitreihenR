...
In the following, we will consider real-world data from the Dow Jones Industrial Average Index. For simplicity, only look at daily closing prices and understand this data as a time series. The first closing price considered is of March 19th 2024, the last data point is of August 9th 2024. Below, the datset (named *dow_data*) we will deal with is shown:  
